...
public class AnyMarkPrim extends ExpandablePrim implements TokenList.Maintainer {
  ...
  public AnyMarkPrim(String name) {
    this(name, TokenList.EMPTY);
  }

  private void readObject(ObjectInputStream input) throws IOException, ClassNotFoundException {
    input.defaultReadObject();
    value = TokenList.EMPTY;
  }
  ...
  public void setToksValue(TokenList val) {
    value = val;
  }
