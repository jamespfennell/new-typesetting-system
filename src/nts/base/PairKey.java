...
/**
 * Hashable pair of objects. Used as a key to hash tables where association to pair of objects is
 * needed.
 *
 * @author Karel Skoupy
 * @version ${VERSION}
...
public final class PairKey implements Serializable {
   ...
   * @return |true| if |o| is a |PairKey| and the first resp. the second items are equal, |false|
   *     otherwise.
   */
