...
public class	ChrKernNode	extends IntHKernNode {
    ...
    public ChrKernNode(Dimen kern) { super(kern); }

    public void		addOn(Log log, CntxLog cntx)
	{ log.addEsc("kern").add(kern.toString()); }

    public byte		beforeWord() { return SKIP; }
    public boolean	canBePartOfWord() { return true; }
    public byte		afterWord() { return SKIP; }
    public boolean	rightBoundary() { return true; }

    public String	toString() { return "ChrKern(" + kern + ')'; }
