...
public abstract class AlignPrim extends BuilderPrim {
  ...
  public AlignPrim(String name, TokenList.Inserter everyCr, Primitive carRet, Command endv) {
    super(name);
    this.everyCr = everyCr;
    frozenCr = new FrozenToken(carRet);
    frozenEndTemplate =
        new FrozenToken("endtemplate", new EndTemplate(new FrozenToken("endtemplate", endv)));
  }
