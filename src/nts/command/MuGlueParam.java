...
public class MuGlueParam extends AnyGlueParam {
  ...
  /**
   * Creates a new MuGlueParam with given name and value and stores it in language interpreter
   * |EqTable|.
   *
   * @param name the name of the MuGlueParam
   * @param val the value of the MuGlueParam
   */
  public MuGlueParam(String name, Glue val) {
    super(name, val);
  }

  /**
   * Creates a new MuGlueParam with given name and stores it in language interpreter |EqTable|.
   *
   * @param name the name of the MuGlueParam
   */
  public MuGlueParam(String name) {
    super(name);
  }
