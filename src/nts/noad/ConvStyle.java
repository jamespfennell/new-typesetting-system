...
public abstract class ConvStyle implements TransfConstants {
  ...
  public abstract Node fetchSufficientNode(Delimiter delimiter, Dimen desired);

  public abstract Box fetchFittingWidthBox(byte fam, CharCode code, Dimen desired);
  ...
  public abstract MathWordBuilder getWordBuilder(byte fam, TreatNode proc);
    ...
    switch (how) {
      ...
      case SUPER_SCRIPT:
        switch (style) {
          ...
          case Noad.TEXT_STYLE:
            s = Noad.SCRIPT_STYLE;
            break;
          default:
            s = Noad.SCRIPT_SCRIPT_STYLE;
            break;
        }
        ;
        break;
  ...
  static {
    ...
    initSymbolPar(DP_MATH_X_HEIGHT, FontMetric.DIMEN_PARAM_MATH_X_HEIGHT);
    initSymbolPar(DP_MATH_QUAD, FontMetric.DIMEN_PARAM_MATH_QUAD);
    initSymbolPar(DP_NUM1, FontMetric.DIMEN_PARAM_NUM1);
    initSymbolPar(DP_NUM2, FontMetric.DIMEN_PARAM_NUM2);
    initSymbolPar(DP_NUM3, FontMetric.DIMEN_PARAM_NUM3);
    initSymbolPar(DP_DENOM1, FontMetric.DIMEN_PARAM_DENOM1);
    initSymbolPar(DP_DENOM2, FontMetric.DIMEN_PARAM_DENOM2);
    initSymbolPar(DP_SUP1, FontMetric.DIMEN_PARAM_SUP1);
    initSymbolPar(DP_SUP2, FontMetric.DIMEN_PARAM_SUP2);
    initSymbolPar(DP_SUP3, FontMetric.DIMEN_PARAM_SUP3);
    initSymbolPar(DP_SUB1, FontMetric.DIMEN_PARAM_SUB1);
    initSymbolPar(DP_SUB2, FontMetric.DIMEN_PARAM_SUB2);
    initSymbolPar(DP_SUP_DROP, FontMetric.DIMEN_PARAM_SUP_DROP);
    initSymbolPar(DP_SUB_DROP, FontMetric.DIMEN_PARAM_SUB_DROP);
    initSymbolPar(DP_DELIM1, FontMetric.DIMEN_PARAM_DELIM1);
    initSymbolPar(DP_DELIM2, FontMetric.DIMEN_PARAM_DELIM2);
    initSymbolPar(DP_AXIS_HEIGHT, FontMetric.DIMEN_PARAM_AXIS_HEIGHT);
    initExtensionPar(DP_DEFAULT_RULE_THICKNESS, FontMetric.DIMEN_PARAM_DEFAULT_RULE_THICKNESS);
    initExtensionPar(DP_BIG_OP_SPACING1, FontMetric.DIMEN_PARAM_BIG_OP_SPACING1);
    initExtensionPar(DP_BIG_OP_SPACING2, FontMetric.DIMEN_PARAM_BIG_OP_SPACING2);
    initExtensionPar(DP_BIG_OP_SPACING3, FontMetric.DIMEN_PARAM_BIG_OP_SPACING3);
    initExtensionPar(DP_BIG_OP_SPACING4, FontMetric.DIMEN_PARAM_BIG_OP_SPACING4);
    initExtensionPar(DP_BIG_OP_SPACING5, FontMetric.DIMEN_PARAM_BIG_OP_SPACING5);
  }
}
