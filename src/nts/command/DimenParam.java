...
public class DimenParam extends AnyDimenParam implements Dimen.Provider {

  /**
   * Creates a new DimenParam with given name and value and stores it in language interpreter
   * |EqTable|.
   *
   * @param name the name of the DimenParam
   * @param val the value of the DimenParam
   */
  public DimenParam(String name, Dimen val) {
    super(name, val);
  }

  /**
   * Creates a new DimenParam with given name and stores it in language interpreter |EqTable|.
   *
   * @param name the name of the DimenParam
   */
  public DimenParam(String name) {
    super(name);
  }
