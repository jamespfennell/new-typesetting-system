...
/**
 * |LineInput| reads the input line by line and performs the conversions from input character codes
...
public class LineInput {
  ...
  /**
   * Reads one line from the input, remove trailing characters which should be ignored (usually
   * spaces) and appends end line character if defined.
   *
   * @param addEolc flag indicating whether the |endLineChar| (if active) should be added.
   * @return an object representing the current input line or |EOF| if the input is finished.
   */
