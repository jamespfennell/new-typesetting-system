...
public class TeXTokenMaker implements InputLineTokenizer.TokenMaker {
  ...
  private byte[] scanCats = new byte[TeXConfig.MAX_CATEGORY + 1];

  private CharToken.Maker[] charTokMakers = new CharToken.Maker[TeXConfig.MAX_CATEGORY + 1];
   ...
   */
  public Token make(CharCode code) {
    CharToken.Maker maker = charTokMakers[categorizer.catCode(code.toChar())];
