...
public class ScanToksChecker extends BaseToksChecker {
  ...
  public ScanToksChecker(
      String tokErr, String eofErr, String desc, MaxLoggable list, Loggable src, Token ins) {
  ...
  public ScanToksChecker(
      String tokErr, String eofErr, String desc, MaxLoggable list, Loggable src) {
    super(tokErr, eofErr, src);
    this.desc = desc;
    this.list = list;
