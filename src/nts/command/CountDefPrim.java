...
//
// Filename: nts/command/CountDefPrim.java
// $Id: CountDefPrim.java,v 1.1.1.1 1999/06/24 10:52:04 ksk Exp $
package nts.command;

import nts.base.Num;

public class CountDefPrim extends ShorthandDefPrim {

  private CountPrim reg;

  public CountDefPrim(String name, CountPrim reg) {
    super(name);
    this.reg = reg;
  }
  ...
  public class Shorthand extends ShorthandDefPrim.Shorthand implements Num.Provider {
