...
public abstract class BoxDimenPrim extends AssignPrim implements Dimen.Provider {
  ...
  protected void assign(Token src, boolean glob) {
    ...
    if (sizes != BoxSizes.NULL) reg.foist(idx, box.pretendSizesCopy(changeSizes(sizes, dimen)));
  }
