 ...
 */
public class	SkipPrim	extends RegisterPrim
				implements Glue.Provider {

    /**
     * Creates a new |SkipPrim| with given name and stores it
     * in language interpreter |EqTable|.
     * @param	name the name of the |SkipPrim|
     */
    public SkipPrim(String name) { super(name); }
    ...
    public Glue		getGlueValue() { return get(scanRegisterCode()); }
