...
public class ToksParam extends ParamPrim implements TokenList.Provider, TokenList.Inserter {

  private TokenList value;

  /**
   * Creates a new ToksParam with given name and value and stores it in language interpreter
   * |EqTable|.
   *
  ...
  /**
   * Creates a new ToksParam with given name and stores it in language interpreter |EqTable|.
   *
   * @param name the name of the ToksParam
   */
  public ToksParam(String name) {
    this(name, TokenList.EMPTY);
  }
