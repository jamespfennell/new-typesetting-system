...
public class	PageTotalPrim	extends PageDimenPrim {
    ...
    public PageTotalPrim(String name, PageSplit page) { super(name, page); }

    protected Dimen	get() { return page.soFar.getNatural(); }

    protected void	set(Dimen dim) { page.soFar.setNatural(dim); }
