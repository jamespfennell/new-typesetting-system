...
// 
// Filename: nts/align/HAlignBuilder.java
// $Id: HAlignBuilder.java,v 1.1.1.1 2000/08/08 04:36:35 ksk Exp $
package	nts.align;

import	nts.builder.HBoxBuilder;

public class	HAlignBuilder	extends HBoxBuilder {
    public HAlignBuilder(int line) { super(line); }
