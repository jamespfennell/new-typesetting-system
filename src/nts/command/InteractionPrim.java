...
public class InteractionPrim extends AssignPrim {
  ...
  public static final String[] names = {"batchmode", "nonstopmode", "scrollmode", "errorstopmode"};
  ...
  public static boolean isInteractive() {
    return (value > NONSTOP);
  }

  public static boolean isErrStopping() {
    return (value == ERROR_STOP);
  }
