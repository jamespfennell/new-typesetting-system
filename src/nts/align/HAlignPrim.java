...
public class	HAlignPrim	extends AlignPrim {
    ...
    public HAlignPrim(String name, TokenList.Inserter everyCr,
    ...
    protected Alignment		makeAlignment(Dimen size, boolean exactly,
					      TokenList.Inserter everyCr,
					      Token frzCr, Token frzEndt,
					      ListBuilder builder) {
	return new HorizAlignment(size, exactly, everyCr,
				  frzCr, frzEndt, builder);
    }
