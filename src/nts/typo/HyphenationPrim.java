...
public class	HyphenationPrim	extends TypoAssignPrim {
    ...
    public HyphenationPrim(String name) { super(name); }
	...
	for (;;) {
		...
		if (index > 1) {
		    ...
		    getTypoConfig().getLanguage()
				.setHyphException(buf.toString(), positions);
		    index = 0; buf.setLength(0); hyphBuf.clear();
		}
