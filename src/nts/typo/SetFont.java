...
public class SetFont extends TypoCommand implements TokenList.Provider {

  private final FontMetric metric;

  public SetFont(FontMetric metric) {
    this.metric = metric;
  }
  ...
  public boolean sameAs(Command cmd) {
    return (cmd instanceof SetFont && metric.equals(((SetFont) cmd).metric));
  }
