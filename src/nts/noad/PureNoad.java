...
public abstract class PureNoad extends BaseNoad {
  ...
  public static Node makeRule(Dimen height) {
    return new RuleNode(new BoxSizes(height, Dimen.NULL, Dimen.ZERO, Dimen.NULL));
  }

  /* TeXtp[705] */
  public static Node makeOverBar(Node node, Dimen clearence, Dimen thickness, Dimen extra) {
  ...
  /* TeXtp[735] */
  public static Node makeUnderBar(Node node, Dimen clearence, Dimen thickness, Dimen extra) {
  ...
  /* TeXtp[706] */
  public static Node varDelimiter(Delimiter del, Dimen size, Transformer transf) {
