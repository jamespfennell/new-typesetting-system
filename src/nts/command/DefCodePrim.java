...
/** */
public class DefCodePrim extends AssignPrim implements Num.Provider {
  ...
  /**
   * Creates a new |DefCodePrim| with given name and stores it in language interpreter |EqTable|.
   *
