...
/**
 * Hashable pair of integers. Used as a key to hash tables where association to pair of integers is
...
public final class IntPairKey implements Serializable {
   ...
   * @return |true| if |o| is an |IntPairKey| and the first resp. the second items have the same
