...
public final class TeXCharMapper implements CharCode.Maker, InputLine.Mapper, StandardLog.Escape {
  ...
  private static CharCode forNum(int n) {
    return (0 <= n && n <= TeXConfig.MAX_TEX_CHAR) ? new Char((char) n) : CharCode.NULL;
  }
  ...
  */
  ...
  private static final class Char implements CharCode {
    ...
    public char toCanonicalLetter() {
      ...
      return (0 < n && n <= TeXConfig.MAX_TEX_CHAR) ? (char) n : NO_CHAR;
    }
    ...
    public CharCode toLowerCase() {
      int n = config.lcNumCode(code);
      return (0 < n && n <= TeXConfig.MAX_TEX_CHAR) ? new Char((char) n) : this;
    }
    ...
    /**
     * Compares this internal character code to the specified object. The result is |true| if and
     * only if the the argument is not |null| and is the |CharCode| object representing the same
    ...
    public boolean equals(Object o) {
      return (o != null && o instanceof CharCode && ((CharCode) o).match(code));
    }
  ...
  public static class TeXFileName implements FileName {
    ...
    private int indexOfExt(int start) {
      int i = data.length();
      while (--i > start) if (data.codeAt(i).startsFileExt()) return i;
      return data.length();
    }
    ...
    public boolean equals(Object o) {
      return (o != null && o instanceof TeXFileName && data.equals(((TeXFileName) o).data));
    }
