...
public final class SettingContext {
  ...
  public SettingContext(
      BoxSizes around, GlueSetting setting, TypeSetter.Mark start, boolean allowIO) {
    this.around = around;
  ...
  public SettingContext shiftedUp(Dimen shift) {
    return new SettingContext(around.shiftedUp(shift), setting, start, allowIO);
  }

  public SettingContext shiftedLeft(Dimen shift) {
    return new SettingContext(around.shiftedLeft(shift), setting, start, allowIO);
  }
