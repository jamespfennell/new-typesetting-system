...
public class NullFontMetric extends BaseFontMetric {
  ...
  public WordBuilder getWordBuilder(TreatNode proc, boolean bound, boolean discretionaries) {
    return new NullWordBuilder();
  }

  public WordRebuilder getWordRebuilder(TreatNode proc, boolean bound) {
    return new NullWordBuilder();
  }
  ...
  private class NullWordBuilder implements WordRebuilder, MathWordBuilder {
