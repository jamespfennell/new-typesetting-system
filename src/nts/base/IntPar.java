...
/**
 * Output parameter class for the |int| type. Used as a medium for (optional) returning values of
...
public class IntPar {
  ...
  /**
   * Sets the value of the |IntPar| if the |IntPar| is given (non-|null|)
   *
