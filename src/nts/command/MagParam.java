...
public class MagParam extends NumParam {
  ...
  /**
   * Creates a new MagParam with given name and value and stores it in language interpreter
   * |EqTable|.
   *
   * @param name the name of the MagParam
   * @param val the value of the MagParam
   */
  public MagParam(String name, Num val) {
    super(name, val);
  }

  public MagParam(String name, int val) {
    super(name, val);
  }

  /**
   * Creates a new MagParam with given name and stores it in language interpreter |EqTable|.
   *
   * @param name the name of the MagParam
   */
  public MagParam(String name) {
    super(name);
  }
